      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="profile.php">edit<span class="sr-only">(current)</span></a>
          </li>
             <li class="nav-item ">
...
<td><input type=text name=alast value='" . $row["last"] . "'></td>
<td><input type=text name=afirst value='" . $row["first"] . "'></td>
<td><input type=text name=astreet value='" . $row["streetnum"] . "'></td>
<td><input type=text name=asname value='" . $row["streetname"] . "'></td>
<td><input type=text name=acity value='" . $row["city"] . "'></td>
<td><input type=text name=ast value='" . $row["state"] . "'></td>
<td><input type=text name=azip value='" . $row["zip"] . "'></td>
