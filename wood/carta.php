      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="carta.php">Cartas<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
...
<script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
  ...
  <div class="py-2">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-center">Carta Search...</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <form action="" method="post">
          <form class="px-0">
            <div class="form-group"> <label></label>
              <form name="form1" method = "post" action="carta.php">
